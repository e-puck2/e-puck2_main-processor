...
extern "C"
{
  ...
  typedef struct
  {
    uint8_t ICM_ACCEL_XOUT_H;
  } ICM_20948_ACCEL_XOUT_H_t;

  typedef struct
  {
    uint8_t ICM_ACCEL_XOUT_L;
  } ICM_20948_ACCEL_XOUT_L_t;

  typedef struct
  {
    uint8_t ICM_ACCEL_YOUT_H;
  } ICM_20948_ACCEL_YOUT_H_t;

  typedef struct
  {
    uint8_t ICM_ACCEL_YOUT_L;
  } ICM_20948_ACCEL_YOUT_L_t;

  typedef struct
  {
    uint8_t ICM_ACCEL_ZOUT_H;
  } ICM_20948_ACCEL_ZOUT_H_t;

  typedef struct
  {
    uint8_t ICM_ACCEL_ZOUT_L;
  } ICM_20948_ACCEL_ZOUT_L_t;

  typedef struct
  {
    uint8_t ICM_GYRO_XOUT_H;
  } ICM_20948_GYRO_XOUT_H_t;

  typedef struct
  {
    uint8_t ICM_GYRO_XOUT_L;
  } ICM_20948_GYRO_XOUT_L_t;

  typedef struct
  {
    uint8_t ICM_GYRO_YOUT_H;
  } ICM_20948_GYRO_YOUT_H_t;

  typedef struct
  {
    uint8_t ICM_GYRO_YOUT_L;
  } ICM_20948_GYRO_YOUT_L_t;

  typedef struct
  {
    uint8_t ICM_GYRO_ZOUT_H;
  } ICM_20948_GYRO_ZOUT_H_t;

  typedef struct
  {
    uint8_t ICM_GYRO_ZOUT_L;
  } ICM_20948_GYRO_ZOUT_L_t;

  typedef struct
  {
    uint8_t ICM_TEMP_OUT_H;
  } ICM_20948_TEMP_OUT_H_t;

  typedef struct
  {
    uint8_t ICM_TEMP_OUT_L;
  ...
  typedef struct
  {
    uint8_t ICM_FIFO_COUNTH;
  } ICM_20948_FIFO_COUNTH_t;

  typedef struct
  {
    uint8_t ICM_FIFO_COUNTL;
