...
#ifndef _I2C_MS_LLD_H_
#define _I2C_MS_LLD_H_


#if HAL_USE_I2C1_MS || defined(__DOXYGEN__)
 ...
 */
#if !defined(HAL_USE_I2C1_MS_SLAVE) || defined(__DOXYGEN__)
#define HAL_USE_I2C1_MS_SLAVE					FALSE
...
typedef struct {
  ...
  i2cdutycycle_t  duty_cycle;    /**< @brief Specifies the I2C fast mode
                                      duty cycle.                           */
#if HAL_USE_I2C_STARTFIX && HAL_USE_I2C1_MS_SLAVE
...
#if HAL_USE_I2C1_MS_SLAVE   /* I2C slave mode support */
...
#if HAL_USE_I2C_LOCK || HAL_USE_I2C1_MS_SLAVE
  /**
